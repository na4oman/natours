...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXRhbmFzLWlyaWtldiIsImEiOiJjazh5a3A0MjkwMmFuM3RvMjB1OHhsZTR6In0.7PvI1gZCbW67z0fgD3BHPQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/atanas-irikev/ck8ylchms1vmi1io732audw8v' //   scrollZoom: false,
    //   zoom: 5,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            // console.log(err.response); // Incorrect email or password - Unauthorized
...
var stripe = Stripe('pk_test_GUX2ymiOi31cY07Ju8tvPvSU00EtTmYejR');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/app/v1/bookings/checkout-session/".concat(tourId));
